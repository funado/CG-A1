...
//Toon Shading Testing
uniform bool u_Toon;
const float levels = 3.0;

//Rim Lighting Testing
//uniform bool u_Rim;
...
void main() {
	...
	//RL
	//vec3 norm = normalize(mat3(u_VM) * v_Normal);
	//vec3 pos = vec3(u_VM * v_Position);
	//vec3 eye = normalize(-pos);
	//float rim = 1.0 - max(dot(eye,norm),0.0);
	...
	if(u_Rim)
	{
		//result = vec3(smoothstep(0.6, 1.0, rim));
	}
	else
	{
		result = (
